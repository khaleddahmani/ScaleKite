 ...
 * This file demonstrates how to integrate Scalekite with a web frontend
 */

// For React/Vue/Angular applications
export class ScalekiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ScalekiteClient(provider, contractAddress);
